...
public class UpdatePlans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        values = Arrays.asList("-Select Plan Type-", "Morning", "AfterNoon", "Evening", "Night", "FullDay");

        values2 = Arrays.asList("-Select Plan Duration-", "7 Days", "15 Days", "Monthly", "Quarterly", "Half Year", "Yearly");
        ...
        spinner.setSelection(values.indexOf(getIntent().getStringExtra("PlanType")));
        nameEditText.setText(getIntent().getStringExtra("PlanName"));
        amountEditText.setText(getIntent().getStringExtra("Amount"));
        String desiredName1 = getIntent().getStringExtra("Duration"); // Replace this with the name of the item you want to select
        spinner2.setSelection(values2.indexOf(desiredName1));
        descEditText.setText(getIntent().getStringExtra("PlanDesc"));
        ...
        button.setOnClickListener(v -> {
            ...
            if (isFormValid()) {
                ...
                progressDialog.setMessage("Plan updating...");
                ...
                try {
                    ...
                    jsonBody.put("PlanID", getIntent().getStringExtra("PlanID"));
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.plan_Insert_Update, jsonBody,
                        response -> {
                            ...
                            Intent intent = new Intent(UpdatePlans.this, ViewPlans.class);
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(UpdatePlans.this, error.toString(), Toast.LENGTH_SHORT).show();
                });
