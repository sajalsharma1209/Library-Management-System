...
public class UpdateSeat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seatno.setText(getIntent().getStringExtra("seat"));
        seatID = getIntent().getStringExtra("SeatID");

        spinner.setSelection(values.indexOf(getIntent().getStringExtra("Shift")));
            ...
            if (isFormValid()) {
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.Seat_Insert_Update, jsonBody,
                        response -> {
                            ...
                            Toast.makeText(this, "Seat Updated Successfully", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(UpdateSeat.this, ViewStudents.class);
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(UpdateSeat.this, error.toString(), Toast.LENGTH_SHORT).show();
                });
